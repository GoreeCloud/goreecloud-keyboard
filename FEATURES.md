...
- No Android network permission in the current foundation; emoji recents do not synchronize or emit telemetry.
...
- Emoji search, broader composed-sequence coverage, complete grapheme segmentation, and additional language/locale input modes.
